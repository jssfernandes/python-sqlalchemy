...
if cars is None or not cars:
    ...
    create_car = [
        ...
        Car(colors=colors_cars(), id=2, model="Mustang GT 500", year_manufacture=1969, country_origin="USA", engine_power=430, manufacturer_id=create_manufacturer[1].id),
        Car(colors=colors_cars(), id=3, model="Gol GTi", year_manufacture=1989, country_origin="BR", engine_power=120, manufacturer_id=create_manufacturer[2].id),
        Car(colors=create_color, id=4, model="Opala SS", year_manufacture=1974, country_origin="BR", engine_power=250, manufacturer_id=create_manufacturer[0].id),
        Car(colors=colors_cars(), id=5, model="Maverick GT", year_manufacture=1974, country_origin="BR", engine_power=199, manufacturer_id=create_manufacturer[1].id),
    ]
